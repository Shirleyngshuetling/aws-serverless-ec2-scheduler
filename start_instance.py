...
def lambda_handler(event, context):
    ...
    ec2_client = boto3.client('ec2', region_name='ap-south-1') # Replace Region name

    # Specify the instance ID of the EC2 instance wanted to start
    instance_id = 'i-051262059d6f6350a' # Replace Instance ID
